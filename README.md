...
- How to structure a site as a story using sections and timeline-based content.
- How to create a clean navigation with anchor links and a responsive mobile menu. 
- How typography, spacing, and imagery build a consistent "editorial" look and feel.
- How to make the site more professional with metadata (title/description/social sharing) and organized HTML/CSS structure. 
